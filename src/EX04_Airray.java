...
public class EX04_Airray {

	public static void main(String[] args) {
		//배열(Array) : 같은(변수)타입의 테이터를 하나의 변수에
		//             저장하는 구조
		...
		//배열 초기화 
		num1 = new int[] {10,20}; // index[0,1,2,3~]
	   ...
	   //배열 값 입력  시 타입을 맞춰서 입력!
	     ...
	     System.out.println("String타입에서 2번째 집에 저장된 값:");
